...
const DOC_TYPES = [
  ...
  {
    id: "tna", label: "TNA", full: "Training Needs Analysis", icon: "🎓",
    desc: "Analisis kebutuhan pelatihan & pengembangan SDM", color: "#A78BFA", cat: "Pengembangan",
    fields: [
      { key: "departemen", label: "Departemen / Divisi", type: "text", placeholder: "Human Resources / Engineering" },
      { key: "periode", label: "Periode TNA", type: "text", placeholder: "2025 (Januari – Desember)" },
      { key: "jumlah_karyawan", label: "Jumlah Karyawan yang Dianalisis", type: "number", placeholder: "30" },
      { key: "metode_analisis", label: "Metode Pengumpulan Data", type: "textarea", placeholder: "Kuesioner online, wawancara 1:1, observasi lapangan, hasil evaluasi kinerja..." },
      { key: "gap_kompetensi", label: "Gap Kompetensi yang Ditemukan", type: "textarea", placeholder: "Kurangnya kemampuan komunikasi lintas divisi, minimnya pemahaman tools analitik, kebutuhan sertifikasi teknis..." },
      { key: "prioritas_training", label: "Prioritas Program Pelatihan", type: "textarea", placeholder: "1. Leadership untuk middle manager\n2. Data Analytics untuk tim operasional\n3. Soft skill komunikasi..." },
      { key: "metode_training", label: "Metode Pelatihan yang Diusulkan", type: "textarea", placeholder: "In-house training, e-learning, workshop eksternal, mentoring, on-the-job training..." },
      { key: "target_peserta", label: "Target Peserta & Level Jabatan", type: "textarea", placeholder: "Staff junior (1–3 tahun), supervisor, manajer madya..." },
      { key: "estimasi_biaya", label: "Estimasi Anggaran Pelatihan", type: "text", placeholder: "Rp 75.000.000 / tahun" },
      { key: "kpi_training", label: "KPI & Ukuran Keberhasilan Pelatihan", type: "textarea", placeholder: "Pre-post test score min 80%, aplikasi ilmu dalam 3 bulan, feedback score > 4/5..." },
    ],
  },
  {
    id: "onboarding", label: "Onboarding", full: "Checklist Onboarding Karyawan Baru", icon: "🎉",
    desc: "Panduan & checklist penerimaan karyawan baru", color: "#22D3EE", cat: "Administrasi",
    fields: [
      { key: "nama_karyawan", label: "Nama Karyawan Baru", type: "text", placeholder: "Budi Santoso" },
      { key: "jabatan", label: "Jabatan / Posisi", type: "text", placeholder: "Junior Software Engineer" },
      { key: "departemen", label: "Departemen", type: "text", placeholder: "Engineering" },
      { key: "tanggal_bergabung", label: "Tanggal Mulai Bergabung", type: "text", placeholder: "1 Februari 2025" },
      { key: "buddy", label: "Nama Buddy / Mentor yang Ditunjuk", type: "text", placeholder: "Andi Wijaya – Senior Engineer" },
      { key: "persiapan_admin", label: "Persiapan Administrasi (H-3 sebelum masuk)", type: "textarea", placeholder: "Kontrak kerja, BPJS, buku rekening payroll, ID card, email perusahaan, akun HRIS..." },
      { key: "perlengkapan", label: "Perlengkapan & Aset yang Disiapkan", type: "textarea", placeholder: "Laptop, akses kartu, seragam, meja & kursi, alat tulis, nomor telepon dinas..." },
      { key: "akses_sistem", label: "Akses Sistem yang Perlu Diaktifkan", type: "textarea", placeholder: "Email, Slack, HRIS, GitLab, Figma, akses VPN, sistem absensi..." },
      { key: "orientasi", label: "Jadwal Orientasi & Perkenalan", type: "textarea", placeholder: "Hari 1: Tur kantor & perkenalan tim\nHari 2: Company culture & values\nHari 3: Briefing tools & sistem..." },
      { key: "target_30_60_90", label: "Target 30–60–90 Hari Pertama", type: "textarea", placeholder: "30 hari: Memahami produk & codebase\n60 hari: Kontribusi fitur pertama\n90 hari: Mandiri dalam task..." },
      { key: "dokumen_wajib", label: "Dokumen yang Harus Diserahkan Karyawan", type: "textarea", placeholder: "KTP, KK, ijazah, SKCK, foto 3x4, NPWP, buku rekening, surat pengalaman kerja..." },
    ],
  },
  {
    id: "offboarding", label: "Offboarding", full: "Checklist Offboarding Karyawan", icon: "🚪",
    desc: "Checklist & prosedur resign / PHK / pensiun", color: "#FB923C", cat: "Administrasi",
    fields: [
      { key: "nama_karyawan", label: "Nama Karyawan", type: "text", placeholder: "Budi Santoso" },
      { key: "nik", label: "NIK / ID Karyawan", type: "text", placeholder: "EMP-2021-0045" },
      { key: "jabatan", label: "Jabatan / Posisi", type: "text", placeholder: "Senior Software Engineer" },
      { key: "departemen", label: "Departemen", type: "text", placeholder: "Engineering" },
      { key: "alasan_keluar", label: "Alasan Keluar", type: "select", options: ["Resign (Pengunduran Diri)", "PHK (Pemutusan Hubungan Kerja)", "Pensiun", "Kontrak Berakhir / Tidak Diperpanjang", "Meninggal Dunia"] },
      { key: "tanggal_efektif", label: "Tanggal Terakhir Bekerja", type: "text", placeholder: "31 Januari 2025" },
      { key: "aset_perusahaan", label: "Daftar Aset yang Harus Dikembalikan", type: "textarea", placeholder: "Laptop Dell, access card, seragam, kendaraan dinas, token..." },
      { key: "akses_sistem", label: "Akses Sistem yang Perlu Dinonaktifkan", type: "textarea", placeholder: "Email, Slack, HRIS, GitLab, database produksi, VPN..." },
      { key: "kewajiban_keuangan", label: "Kewajiban Keuangan (jika ada)", type: "textarea", placeholder: "Talangan biaya training, pinjaman karyawan, hutang cuti..." },
      { key: "knowledge_transfer", label: "Proses Knowledge Transfer", type: "textarea", placeholder: "Dokumentasi project, handover kepada rekan, briefing successor..." },
      { key: "hak_karyawan", label: "Hak Karyawan yang Harus Dibayarkan", type: "textarea", placeholder: "Gaji bulan terakhir, uang pisah, pesangon, saldo BPJS TK, THR pro-rata..." },
    ],
  },
  {
    id: "appraisal", label: "Performance Appraisal", full: "Form Penilaian Kinerja Karyawan", icon: "⭐",
    desc: "Formulir evaluasi kinerja tahunan / mid-year review", color: "#FBBF24", cat: "Penilaian",
    fields: [
      { key: "nama_karyawan", label: "Nama Karyawan", type: "text", placeholder: "Budi Santoso" },
      { key: "jabatan", label: "Jabatan / Posisi", type: "text", placeholder: "Senior Software Engineer" },
      { key: "departemen", label: "Departemen", type: "text", placeholder: "Engineering" },
      { key: "periode", label: "Periode Penilaian", type: "text", placeholder: "Januari – Desember 2025 (Annual Review)" },
      { key: "penilai", label: "Nama Penilai / Atasan Langsung", type: "text", placeholder: "Andi Wijaya – Engineering Manager" },
      { key: "target_awal", label: "Target yang Ditetapkan di Awal Periode", type: "textarea", placeholder: "Menyelesaikan 3 fitur utama, meningkatkan test coverage 80%, memimpin 2 sprint..." },
      { key: "pencapaian", label: "Pencapaian & Realisasi", type: "textarea", placeholder: "Berhasil deliver 3 fitur on-time, test coverage naik ke 85%, memimpin sprint dengan velocity stabil..." },
      { key: "kompetensi_teknis", label: "Penilaian Kompetensi Teknis (1–5)", type: "textarea", placeholder: "Problem solving: 4, Technical depth: 5, Code quality: 4, Documentation: 3..." },
      { key: "kompetensi_perilaku", label: "Penilaian Kompetensi Perilaku / Soft Skill (1–5)", type: "textarea", placeholder: "Komunikasi: 4, Teamwork: 5, Inisiatif: 4, Adaptasi: 3..." },
      { key: "area_pengembangan", label: "Area yang Perlu Dikembangkan", type: "textarea", placeholder: "Perlu meningkatkan kemampuan presentasi, belajar cloud architecture, leadership skill..." },
      { key: "rencana_pengembangan", label: "Rencana Pengembangan Tahun Depan", type: "textarea", placeholder: "Mengikuti pelatihan AWS Certified, mentoring junior developer, ambil sertifikasi PMP..." },
    ],
  },
];
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0a0a12", fontFamily: "'DM Sans', sans-serif", color: "#e2ddd6" }}>
      ...
      <footer style={{
        ...
        <span style={{ fontSize: 11, color: "#3d3a50", fontFamily: "'DM Mono', monospace", letterSpacing: "0.5px" }}>
          Crafted with ♥ by
        </span>
        <span style={{
